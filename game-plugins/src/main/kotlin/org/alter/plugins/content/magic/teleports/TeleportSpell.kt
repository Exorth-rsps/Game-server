...
enum class TeleportSpell(val spellName: String, val type: TeleportType, val endArea: Area,
     ...
     * Standard.
     */
    VARROCK("Seers Teleport", TeleportType.MODERN, Area(2761, 1722, 2764, 1725), 35.0),
    LUMBRIDGE("Lands End Teleport", TeleportType.MODERN, Area(2565, 1744, 2570, 1749), 41.0),
